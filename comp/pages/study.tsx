...
// import { KEY_SET_V1, KEY_SET_V2, PAGES } from '@/util/common'
...
//   const {isSpeedMode, words } = useAppContext()
...
//         {words ? ' is enabled for characters. Use the spacebar to submit words.' : ' is enabled. Use the spacebar to see the answer.'}
//       </Typography>
//     )
//   }
...
//       // setKanas(isHiragana(hiragana, hiraganaDouble, hiraganaWords, katakana, katakanaDouble, katakanaExtended, katakanaWords))
//     } else {
...
//   )
// }
export const Study: FC<_StudyProps> = () => {
  return <div>Study Component</div>
}

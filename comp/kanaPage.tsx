...
export const KanaPage: FC<_KanaPageProps> = ({ columns, id, label, link, linkLabel, next, previous, rangeEnd, rangeStart, tab, variant }) => (
  <Base tab={tab}>
    <Box id="top" sx={{ ...TOP.main, ...LOCAL.top }}>
      <Box id="kana">
        ...
        <Kana columns={columns} kanaPageId={id} rangeEnd={rangeEnd} rangeStart={rangeStart} />
      </Box>

      <Preview isHiragana={tab === Tabs.HIRAGANA} />
    </Box>

    <Box sx={BOTTOM.main}>
      <CheckUncheckAll kanaPageId={id} />
